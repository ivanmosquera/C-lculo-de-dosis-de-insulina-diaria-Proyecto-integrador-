...
public class Detalle_Plato_Auto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle__plato__auto);
        txtnombrecomida = findViewById(R.id.txtNombreComidasauto);
        txtcarbohidratos =  findViewById(R.id.txtcalorias_dessauto);
        txttotal = findViewById(R.id.food_total_carbosauto);
        elegantNumberButton = (ElegantNumberButton) findViewById(R.id.numbre_buttonsauto);
        cantidad = elegantNumberButton.getNumber();
        btn_agregar = (Button)findViewById(R.id.btn_agregar_listaauto);
        ...
        btn_agregar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new Database(getBaseContext()).addPlatosAuto(new Platos("A1",nombre,calorias,cantidad));
