 ...
 * {@link Detalle_Pla_Auto.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Detalle_Pla_Auto#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Detalle_Pla_Auto extends Fragment {
     ...
     * @return A new instance of fragment Detalle_Pla_Auto.
     */
    // TODO: Rename and change types and number of parameters
    public static Detalle_Pla_Auto newInstance(String param1, String param2) {
        Detalle_Pla_Auto fragment = new Detalle_Pla_Auto();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view  = inflater.inflate(R.layout.fragment_detalle_pla_auto, container, false);
        txtnombrecomida = view.findViewById(R.id.txtNombreComidasauto);
        txtcarbohidratos =  view.findViewById(R.id.txtcalorias_dessauto);
        txttotal = view.findViewById(R.id.food_total_carbosauto);
        elegantNumberButton = (ElegantNumberButton) view.findViewById(R.id.numbre_buttonsauto);
        cantidad = elegantNumberButton.getNumber();
        back = (ImageView) view.findViewById(R.id.back_platosselec);
        btn_agregar = (Button)view.findViewById(R.id.btn_agregar_listaauto);
        ...
        btn_agregar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new Database(getActivity()).addPlatosAuto(new Platos("A1",nombre,calorias,cantidad));
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            Toast.makeText(context,"Detalle auto Comida",Toast.LENGTH_SHORT);
        }
    }
